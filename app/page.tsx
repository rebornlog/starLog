  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 sm:px-6 py-8 sm:py-12">
      <div className="text-center max-w-5xl mx-auto w-full">
        ...
        {/* 副标题 */}
        <p className="text-lg sm:text-xl md:text-2xl text-gray-700 dark:text-gray-200 mb-2 sm:mb-3 font-medium">
          像龙猫森林一样宁静的知识花园
        </p>
        <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed">
          在这里，记录技术的成长轨迹，追踪市场的起伏变化<br className="hidden sm:inline"/>
          探索风水智慧，洞察商业未来<br className="hidden sm:inline"/>
